...
class testMotor implements DcMotor
{
   private double power = 0;
   private int targPosition = 0;
   private int currentPosition = 0;
    ...
    {
      this.targPosition = position;
      currentPosition = targPosition;
    }
    ...
    {
        return this.getTargetPosition() > this.getCurrentPosition() || this.getTargetPosition() < this.getCurrentPosition();
    }
    ...
    {
        //currentPosition += FastMath.round(Range.scale(currentPosition * getPower(),-1.0,1.0,0,400));
    ...
    {
        return String.valueOf(getPower()) + " " +(getTargetPosition()) + " " + getCurrentPosition();
    }
}
