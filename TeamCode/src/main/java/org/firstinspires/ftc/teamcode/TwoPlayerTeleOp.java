...
public class TwoPlayerTeleOp extends RobotMovements {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        try
        {
            ...
            elevatorThread elevatorThread = new elevatorThread(robot.liftMotor, robot.tensionMotor, robot.clampL, robot.clampR, robot.foundationL, robot.foundationR, 1, gamepad2, .1f, 50, 20, 300000, 300000, telemetry);
