package org.firstinspires.ftc.teamcode.OpenCV.DogeCV;
 ...
 */
@TeleOp(name = "Skystone Sample Test", group="DogeCV")
public class SkystoneDetectorExampleV1 extends LinearOpMode
{
    OpenCvCamera webcam;
