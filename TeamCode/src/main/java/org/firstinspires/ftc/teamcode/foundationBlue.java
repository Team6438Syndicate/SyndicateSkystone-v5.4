...
public class foundationBlue extends RobotMovements {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drivingThread simpleDriveThread = new drivingThread(hardwareMap,robot, robot.sensorFront,robot.FL, robot.FR, robot.BL, robot.BR,10,3.0,1.0+1.0/8.0,elevatorAutonThread, telemetry, false,false,true,true,true);
