...
public abstract class pipeTest extends OpenCvPipeline
{
    ...
    protected String detectorName = "Detector";
    ...
    protected pipeTest.Stage stageToRenderToViewport = pipeTest.Stage.FINAL_DISPLAY;
    private pipeTest.Stage[] stages = pipeTest.Stage.values();
