...
@Autonomous(name = "Red Depot Auton", group = "Autonomous")
public class Team6438AutonomousRed extends RobotMovements {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        elevatorThread elevatorAutonThread = new elevatorThread(robot.liftMotor, robot.tensionMotor, robot.clampL, robot.clampR, robot.capstone, 1, 0, 30000, 30000, 20, 20, robot.sensorFront, null);

        OpenCvCamera webcam = startOpenCV();

        drivingThread simpleDriveThread = new drivingThread(hardwareMap,robot, webcam, robot.sensorFront,robot.FL, robot.FR, robot.BL, robot.BR,10,3.0,1.0+1.0/8.0,null,elevatorAutonThread,telemetry,false,true,true,true, true);
