...
import org.firstinspires.ftc.teamcode.markmattcode.SimplifiedHardwareMap;

@Autonomous(name = "Blue Foundation Strafe", group = "Strafe Auton")
public class BlueFoundationStrafe extends LinearOpMode
{
...
//Brad do the thing
    ...
    {
        robot.liftMotor.setTargetPosition((int) ((int) (int)inches*robot.CPILift));
